---
layout: post
title:  "Doctest - my favorite lightweight, zero-friction unit test framework"
permalink: doctest 
comments: true
...
For example, I've been using it in [neschan](https://github.com/yizhang82/neschan/) which is a NES emulator that I wrote for fun back in 2018, and one such example is a few unit test that validates the emulated 6502 CPU works correctly:
